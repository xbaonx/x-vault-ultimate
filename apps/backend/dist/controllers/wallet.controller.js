...
class WalletController {
     ...
     */
    static async getTransactionOptions(req, res) {
        try {
            ...
            const options = await (0, server_1.generateAuthenticationOptions)({
                rpID: config_1.config.security.rpId === 'localhost' ? 'localhost' : config_1.config.security.rpId,
        ...
        try {
            ...
            try {
                ...
                verification = await (0, server_1.verifyAuthenticationResponse)({
                    ...
                    expectedOrigin: config_1.config.security.origin,
                    expectedRPID: config_1.config.security.rpId,
            ...
            if (verification.verified) {
                ...
                res.status(200).json({
                    success: true,
                    txHash: ethers_1.ethers.hexlify(ethers_1.ethers.randomBytes(32)) // Mock Hash
                });
            }
            else {
