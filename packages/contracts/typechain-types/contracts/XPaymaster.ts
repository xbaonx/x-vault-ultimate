...
export interface XPaymasterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "COST_OF_POST"
      | "addStake"
...
export interface XPaymaster extends BaseContract {
  connect(runner?: ContractRunner | null): XPaymaster;
  waitForDeployment(): Promise<this>;

  interface: XPaymasterInterface;
