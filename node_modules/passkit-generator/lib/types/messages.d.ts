...
export declare const PREFERRED_STYLE_SCHEMES: {
    readonly UNEXPECTED_PASS_TYPE_SET: "Cannot set preferredStyleSchemes on a pass with type different from eventTicket or boardingPass.";
    readonly UNEXPECTED_PASS_TYPE_GET: "Cannot get preferredStyleSchemes on a pass with type different from eventTicket or boardingPass.";
    readonly INVALID: "Cannot set preferredStyleSchemes because not compliant with Apple specifications - %s";
};
export declare const UPCOMING_PASS_INFORMATION: {
    readonly UNEXPECTED_PASS_TYPE_SET: "Cannot set upcomingPassInformation on a pass with type different from eventTicket.";
    readonly UNEXPECTED_PASS_TYPE_GET: "Cannot get upcomingPassInformation on a pass with type different from eventTicket.";
    readonly UNEXPECTED_STYLE_SCHEME: "Cannot set upcomingPassInformation because 'preferredStyleSchemes' does not include 'posterEventTicket' style.";
    readonly INVALID: "Cannot set upcomingPassInformation: validation failed. Be sure to follow the Apple specifications. - %s";
};
...
export declare const RELEVANT_DATE: {
    readonly INVALID: "Cannot set relevant date. Date format is invalid";
};
